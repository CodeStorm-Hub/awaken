      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(
            ...
            child: const Text(
              'CANCEL',
              style: TextStyle(color: AppColors.mutedForeground, fontWeight: FontWeight.bold),
            ),
          ),
          ElevatedButton(
                  ...
                  children: [
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ClipOval(
                          child: (isSignedIn && user?.avatarUrl != null && user!.avatarUrl!.isNotEmpty)
                              ? Image.network(
                                  user.avatarUrl!,
                                  fit: BoxFit.cover,
                              ...
                              : Icon(
                                  ...
                                  size: 48,
                                  color: isSignedIn ? AppColors.primary : AppColors.mutedForeground,
                                ),
                        ),
                      ),
                    ...
                    // Display Name
                    Text(
                      isSignedIn ? (user?.displayName ?? 'No Display Name') : 'Guest User',
                    ...
                    Text(
                      isSignedIn ? (user?.email ?? '') : 'Local offline profile',
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: (isSignedIn ? AppColors.success : AppColors.muted).withValues(alpha: 0.1),
                        borderRadius: BorderRadius.circular(16),
                        border: Border.all(
                          color: (isSignedIn ? AppColors.success : AppColors.border).withValues(alpha: 0.25),
                          width: 0.8,
                        ),
                      ),
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
                              color: isSignedIn ? AppColors.success : AppColors.mutedForeground,
                            ),
                          ),
                          const SizedBox(width: 8),
                          Text(
                            isSignedIn ? 'CLOUD SYNCHRONIZED' : 'LOCAL STORAGE ONLY',
                            style: tt.eyebrow.copyWith(
                              color: isSignedIn ? AppColors.success : AppColors.mutedForeground,
                              fontSize: 10,
                            ),
              ...
              if (_error != null)
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      _error!,
                      style: TextStyle(color: AppColors.destructive.withValues(alpha: 0.9), fontSize: 13),
                      textAlign: TextAlign.center,
                    ),
                  ),
                ),
                ...
                builder: (context, constraints) {
                  ...
                  return GridView.count(
                    ...
                    children: [
                      ...
                      _StatItem(
                        title: 'ENERGY',
                        value: stats != null ? '${stats.monthlyCalories}' : '0',
                        unit: 'cal',
                ...
                _loading
                    ...
                    : OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          side: const BorderSide(color: AppColors.destructive, width: 1.0),
                          padding: const EdgeInsets.symmetric(vertical: 16),
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(AppConstants.borderRadius),
                          ),
