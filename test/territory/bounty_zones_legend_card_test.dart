...
void main() {
  final testZone = BountyZoneEntity(
    ...
    ring: [
      GeoPointEntity(latitude: 40.0, longitude: -74.0, timestamp: DateTime.now()),
      GeoPointEntity(latitude: 40.1, longitude: -74.0, timestamp: DateTime.now()),
      GeoPointEntity(latitude: 40.1, longitude: -74.1, timestamp: DateTime.now()),
    ],
  );

  testWidgets('BountyZonesLegendCard renders when visible and not dismissed, hides on close tap', (WidgetTester tester) async {
