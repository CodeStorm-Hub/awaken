...
googleSignInUiOutcome(Object error) {
  if (error is GoogleSignInCanceledException) {
    return (showError: false, clearLoading: true, navigateToDashboard: false);
  }
  return (showError: true, clearLoading: true, navigateToDashboard: false);
}

void main() {
  test('Google cancel clears loading without error or navigation', () {
    final outcome = googleSignInUiOutcome(
